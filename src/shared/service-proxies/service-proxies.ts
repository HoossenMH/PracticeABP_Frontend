...
export class PlayerServiceProxy {
     ...
     * @return Success
     */
    get(id: number | null | undefined) : Observable<PlayerDto> {
        let url_ = this.baseUrl + "/api/services/app/Player/Get?";
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined) : Observable<PagedResultDtoOfPlayerDto> {
        let url_ = this.baseUrl + "/api/services/app/Player/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfPlayerDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfPlayerDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfPlayerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PagedResultDtoOfPlayerDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfPlayerDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: PlayerDto | null | undefined) : Observable<PlayerDto> {
        let url_ = this.baseUrl + "/api/services/app/Player/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<PlayerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(input: PlayerDto | null | undefined) : Observable<PlayerDto> {
        let url_ = this.baseUrl + "/api/services/app/Player/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<PlayerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | null | undefined) : Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Player/Delete?";
        if (id !== undefined && id !== null)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
...
export class PagedResultDtoOfPlayerDto implements IPagedResultDtoOfPlayerDto {
    totalCount: number | undefined;
    items: PlayerDto[] | undefined;

    constructor(data?: IPagedResultDtoOfPlayerDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(PlayerDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfPlayerDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfPlayerDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfPlayerDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfPlayerDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfPlayerDto {
    totalCount: number | undefined;
    items: PlayerDto[] | undefined;
}
